...
public class bookingPanel extends JPanel {
   ...
   static {
    countryPhoneCodes.put("Afghanistan", "+93");
        ...
        countryPhoneCodes.put("South Africa", "+27");
        countryPhoneCodes.put("South Sudan", "+211");
        countryPhoneCodes.put("Spain", "+34");
        countryPhoneCodes.put("Sri Lanka", "+94");
        countryPhoneCodes.put("Sudan", "+249");
        countryPhoneCodes.put("Suriname", "+597");
        countryPhoneCodes.put("Sweden", "+46");
        countryPhoneCodes.put("Switzerland", "+41");
        countryPhoneCodes.put("Syria", "+963");
        countryPhoneCodes.put("Taiwan", "+886");
        countryPhoneCodes.put("Tajikistan", "+992");
        countryPhoneCodes.put("Tanzania", "+255");
        countryPhoneCodes.put("Thailand", "+66");
        countryPhoneCodes.put("Timor-Leste", "+670");
        countryPhoneCodes.put("Togo", "+228");
        countryPhoneCodes.put("Tonga", "+676");
        countryPhoneCodes.put("Trinidad and Tobago", "+1-868");
        countryPhoneCodes.put("Tunisia", "+216");
        countryPhoneCodes.put("Turkey", "+90");
        countryPhoneCodes.put("Turkmenistan", "+993");
        countryPhoneCodes.put("Tuvalu", "+688");
        countryPhoneCodes.put("Uganda", "+256");
        countryPhoneCodes.put("Ukraine", "+380");
        countryPhoneCodes.put("United Arab Emirates", "+971");
        countryPhoneCodes.put("United Kingdom", "+44");
        countryPhoneCodes.put("United States", "+1");
        countryPhoneCodes.put("Uruguay", "+598");
        countryPhoneCodes.put("Uzbekistan", "+998");
        countryPhoneCodes.put("Vanuatu", "+678");
        countryPhoneCodes.put("Vatican City", "+39-06");
        countryPhoneCodes.put("Venezuela", "+58");
        countryPhoneCodes.put("Vietnam", "+84");
        countryPhoneCodes.put("Yemen", "+967");
        countryPhoneCodes.put("Zambia", "+260");
        countryPhoneCodes.put("Zimbabwe", "+263");
    ...
    public bookingPanel(String username) {
        ...
        // Adding First Line Components to Panel
        gbc.gridx = 0;
        gbc.gridy = 0;
        add(userLabel, gbc);
        ...
        JLabel annualVisitorLabel = new JLabel("Annual Visitor:");
        JTextField annualVisitorField = new JTextField(10);
        annualVisitorField.setText("1027"); // Example value
        annualVisitorField.setEditable(false);

        JLabel annualAmountLabel = new JLabel("Annual Amount (Rs.):");
        JTextField annualAmountField = new JTextField(10);
        annualAmountField.setText("70270.00"); // Example value
        annualAmountField.setEditable(false);

        JLabel todayVisitorLabel = new JLabel("Today Visitor:");
        JTextField todayVisitorField = new JTextField(5);
        todayVisitorField.setText("11"); // Example value
        todayVisitorField.setEditable(false);

        JLabel todayAmountLabel = new JLabel("Today Amount (Rs.):");
        JTextField todayAmountField = new JTextField(10);
        todayAmountField.setText("825.00"); // Example value
        todayAmountField.setEditable(false);

        // Adding Second Line Components to Panel
        gbc.gridx = 0;
        gbc.gridy = 2;
        add(annualVisitorLabel, gbc);

        gbc.gridx = 1;
        add(annualVisitorField, gbc);

        gbc.gridx = 2;
        add(annualAmountLabel, gbc);

        gbc.gridx = 3;
        add(annualAmountField, gbc);

        gbc.gridx = 4;
        add(todayVisitorLabel, gbc);

        gbc.gridx = 5;
        add(todayVisitorField, gbc);

        gbc.gridx = 6;
        add(todayAmountLabel, gbc);

        gbc.gridx = 7;
        add(todayAmountField, gbc);

        // Third Line Components
        JLabel fillDetailsLabel = new JLabel("Fill Ticket Details");
       // fillDetailsLabel.setFont(new Font("Arial", Font.BOLD, 14));

        // Adding Third Line Components to Panel
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.gridwidth = 8;
        gbc.anchor = GridBagConstraints.CENTER;
        add(fillDetailsLabel, gbc);
        gbc.gridwidth = 1;
        gbc.anchor = GridBagConstraints.WEST;

        // Fourth Line Components
        JLabel bookingDateLabel = new JLabel("Booking Date:");
        JTextField bookingDateField = new JTextField(LocalDate.now().format(DateTimeFormatter.ISO_DATE));
        bookingDateField.setEditable(false); 
        
        JLabel visitingDateLabel = new JLabel("Visiting Date:");
        JTextField visitingDateField = new JTextField(LocalDate.now().format(DateTimeFormatter.ISO_DATE));
       
       
       
       JLabel ticketNoLabel = new JLabel("Ticket No.:");
        JTextField ticketNoField = new JTextField(15);
        int ticketNumber = getNextFreeTicketNumber();
        ticketNoField.setText(String.valueOf(ticketNumber)); 
        

        // Adding Fourth Line Components to Panel
        gbc.gridx = 0;
        gbc.gridy = 4;
        add(bookingDateLabel, gbc);

        gbc.gridx = 1;
        add(bookingDateField, gbc);

        gbc.gridx = 2;
        add(visitingDateLabel, gbc);

        gbc.gridx = 3;
        add(visitingDateField, gbc);
       
        gbc.gridx = 5;
        add(ticketNoLabel, gbc);

        gbc.gridx = 6;
        add(ticketNoField, gbc);
       ...
       // Concessions Panel
        ...
        gbc.gridx = 4; // Adjust the gridx position to place it correctly in your main layout
        gbc.gridy = 10; // Adjust the gridy position to place it correctly in your main layout
    ...
    private void addListeners() {
       ...
       //visitingDateField.getDocument().addDocumentListener(listener);
    ...
    private int getNextFreeTicketNumber() {
    int ticketNumber = 0;
    try {
        ResultSet rs = db.st.executeQuery("SELECT MAX(TicketNumber) + 1 AS NextTicketNumber FROM Booking");
        if (rs.next()) {
            ticketNumber = rs.getInt("NextTicketNumber");
        }
    } catch (SQLException e) {
        e.printStackTrace();
    }
